...
All ESR experimental work was done by \JBV{} and William Myers (University of Oxford); thus, I only provide very brief descriptions here.
...
\Cref{fig:esrpoise_comp_ampcomp} shows the improved performance of CHORUS after a simple optimisation of the shaped pulse amplitudes, using the spectral intensity as the cost function (or the negative thereof, since we seek to maximise it).
It can be seen that the POISE optimisation allows for a much more accurate spectrum to be obtained.
