...
\begin{figure}[htb]
    ...
    \caption[Projections of ASAP-HSQC spectra before and after optimisation]{
        ...
        \textbf{(\subref*{fig:asaphsqc_spec_proj})} Projections of the ASAP-HSQC spectra before (grey dotted line, using $\Jeff = \qty{150}{\Hz}$) and after (green solid line, using $\Jeff = \qty{245}{\Hz}$) optimisation of the INEPT delay.
