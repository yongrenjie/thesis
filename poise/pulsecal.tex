...
In any case, it is clear that there is a well-defined minimum, located in this case at \qty{48.3}{\us}; we expect that POISE routines will converge to this point.
