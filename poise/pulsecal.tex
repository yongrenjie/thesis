...
\begin{figure}[htb]
    \centering
    \includegraphics[draft=false]{poise/p1_scan.png}
...
\begin{figure}[htb]
    \centering
    \includegraphics[draft=false]{poise/p1_scan_spectra.png}
...
Another question we might reasonably ask is how robust POISE is towards poor initial guesses.
