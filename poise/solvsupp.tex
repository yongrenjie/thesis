...
This possibility is averted here by setting a conservative upper bound of \qty{55}{\Hz} on the presaturation power $k$: this avoids inadvertently saturating nearby resonances.
...
\begin{table}
    ...
    \begin{tabular}{cccccccc}
        ...
        Description & $f_\mathrm{sos} / 10^{18}$ & FEs & Time (\unit{\s}) & $\nu_\text{tx}$ (\unit{\Hz}) & $k$ (\unit{\Hz}) & $\taum$ (\unit{\s}) & $\taur$ (\unit{\s}) \\
        \hline
...
\begin{table}
    ...
    \begin{tabular}{ccccc}
        ...
        \bottomrule
    \end{tabular}
    \caption[Water suppression 1-parameter optimisations]{
...
\begin{table}
    ...
    \begin{tabular}{ccccccc}
        ...
        Entry & Algorithm & $\nu_\text{tx}$ (\unit{\Hz}) & $k$ (\unit{\Hz}) & $f_\text{sos} / 10^{18}$ & FEs    & Time (\unit{\s}) \\
        \midrule
        ...
        \bottomrule
    \end{tabular}
    \caption[Water suppression 2-parameter optimisations]{
...
\begin{table}
    ...
    \begin{tabular}{cccccccc}
        ...
        Entry & Algorithm & $\nu_\text{tx}$ (\unit{\Hz}) & $k$ (\unit{\Hz}) & $\taum$ (\unit{\ms}) & $f_\text{sos} / 10^{18}$ & FEs    & Time (\unit{\s}) \\
        \midrule
        ...
        \bottomrule
    \end{tabular}
    \caption[Water suppression 3-parameter optimisations]{
...
\begin{table}
    ...
    \begin{tabular}{ccccccccc}
        ...
        Entry & Algorithm & $\nu_\text{tx}$ (\unit{\Hz}) & $k$ (\unit{\Hz}) & $\taum$ (\unit{\ms}) & $\taur$ (\unit{\s}) & $f_\text{sos} / 10^{18}$ & FEs    & Time (\unit{\s}) \\
        \midrule
        ...
        \bottomrule
    \end{tabular}
    \caption[Water suppression 4-parameter optimisations]{
