...
\begin{equation}
    ...
    f_{\symup{dosy,aux}} = \frac{\sum_i S_i(\Gmax)}{\sum_i S_i(\Gmin)} - 0.25.
\end{equation}
...
\begin{equation}
    \label{eq:dosy_cf}
    f_{\symup{dosy}} = |f_{\symup{dosy,aux}}| = \left| \frac{\sum_i S_i(\Gmax)}{\sum_i S_i(\Gmin)} - 0.25 \right|.
\end{equation}
...
\begin{equation}
    \label{eq:dosy_2p_cf}
    f_{\symup{dosy,2p}} = f_{\symup{dosy}} + (\Delta / \unit{\s}) = \left| \frac{\sum_i S_i(\Gmax)}{\sum_i S_i(\Gmin)} - 0.25 \right| + (\Delta / \unit{\s})
\end{equation}
