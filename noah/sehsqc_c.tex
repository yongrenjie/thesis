...
This acts as a \angang{90}{-x} pulse on the \magn{C} magnetisation pool and thus ultimately leads to the same signals being detected (save for a trivial \ang{180} phase shift).
