...
\begin{itemize}
    ...
    \item the delays $\Delta$ and $\Delta'$ were both set to $1/(4 \cdot \oneJ{NH})$ to maximise sensitivity for \ch{NH} groups (as before, the value of $\oneJ{NH}$ was set to \qty{90}{\Hz});
...
These were then compared against the basic \noah{Mn,Sp,Cc} supersequence.
...
This in turn arises because \magnnot{N} magnetisation (which includes the \magn{C} component sampled in this module---by definition, protons coupled to \carbon{} are not coupled to \nitrogen{}) precesses in the transverse plane during the $t_1$ period of the \nitrogen{} HSQC and seHSQC1.
