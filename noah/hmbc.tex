...
In addition to a standard second-order LPJF, the NOAH HMBC module \textit{also} contains a $zz$-filter, which stores \magn{C} magnetisation along $+z$ before the LPJF.
