...
However, this is not borne out: in some cases, the NOAH HMBC in fact has \textit{more intense} one-bond artefacts when compared against a standard HMBC experiment (\cref{fig:noah_hmbc_1jch_no90,fig:noah_hmbc_1jch_std_lp2}).
...
\begin{figure}[!ht]
    \centering
    \includegraphics[draft=false]{noah/hmbc_1jch.png}%
