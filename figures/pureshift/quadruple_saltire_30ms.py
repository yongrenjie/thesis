...
pg.read(p, 1016).stage(ax=axs[0], bounds=(3.83, 3.865), color='black')
pg.mkplot(axs[0])
...
maybe_better_spec.stage(bottom_axs[0], bounds=bounds, color=apt.PAL[2])
...
ref_spec.stage(bottom_axs[1], bounds=bounds, color=apt.PAL[1])
...
if plot == 'peak_heights':
    ...
    axs[1].plot(flip_angles, psyche2_sens/1e5, color=apt.PAL[1],
                label='2 saltires', linewidth=1.25)
    axs[1].plot(flip_angles, psyche2_sar/1e5, color=apt.PAL[1],
                linestyle='--', linewidth=1.25)
    axs[1].plot(flip_angles, psyche4_sens/1e5, color=apt.PAL[2],
                label='4 saltires', linewidth=2)
    axs[1].plot(flip_angles, psyche4_sar/1e5, color=apt.PAL[2],
