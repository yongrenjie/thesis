...
fig, axs = pg.subplots(2, 2, figsize=(6.5, 5))

more_epsi = pg.read(apt.nmrd() / '210426-6e-psycheepsi', 12)
more_psychegrad = pg.read(apt.nmrd() / '210505-6e-psycheepsi', 30)
make_epsi_graph(more_epsi, graph_type='kt', gz_max=65.7, ax=axs[0][0])
make_epsi_graph(more_psychegrad, graph_type='kt', gz_max=65.7, ax=axs[0][1])
make_epsi_graph(more_epsi, graph_type='trace', gz_max=65.7, ax=axs[1][0])
make_epsi_graph(more_psychegrad, graph_type='trace', gz_max=65.7, ax=axs[1][1])

apt.label_axes_def([axs[0][0], axs[1][0], axs[0][1], axs[1][1]])
# apt.show()
apt.save(__file__)
