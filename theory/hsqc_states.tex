...
\end{equation}
at point \circled{2}, bearing in mind that the $180^\circ_x(I)$ pulse inverts the $I_z$ component of both terms.
...
Even small artefacts arising from the remaining $99\%$ proton magnetisation may have comparable intensity to the signals of interest.
