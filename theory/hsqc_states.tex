...
\begin{figure}[ht]
    \centering
    \includegraphics[scale=1.2]{pp/hsqc/hsqc_ph.png}
...
\begin{equation}
    ...
    \rho = -2I_zS_y.
\end{equation}
During $t_1$ this evolves to give:
\begin{equation}
    \label{eq:hsqc_ph_after_t1}
    \rho = 2I_zS_y\cos(\Omega_S t_1) - 2I_zS_x \sin(\Omega_S t_1),
\end{equation}
at point \circled{2}, bearing in mind that the $180^\circ_x(I)$ pulse inverts the $I_z$ term.
