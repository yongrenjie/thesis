...
The sensitivity of the ZS method tends to be low (the factor $c$ tends to be on the order of $\sim 0.01$ to $0.05$), as each signal only derives from a narrow region of the sample.
