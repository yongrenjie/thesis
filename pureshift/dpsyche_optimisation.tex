...
\begin{figure}[htb]
    \centering
    \includegraphics[draft=false]{pureshift/td1_cf.png}
...
Optimisations were next carried out with an (arbitrarily chosen) setting of $m = 9$ (i.e.\ nine hard pulses in the PSE).
...
\begin{figure}[htb]
    ...
    % date and rerun it.
    \centering
    \includegraphics[draft=false]{pureshift/dpsyche_nosens_vs_psyche}
...
To evaluate the quality of the decoupling on a real sample, the dPSYCHE experiment was experimentally acquired. \cref{fig:dpsyche_nosens_vs_psyche} compares the results against a PSYCHE experiment.
...
\begin{figure}[htbp]
    ...
    \centering
    \includegraphics[draft=false]{pureshift/dpsyche_sens.png}
...
\begin{figure}[htb]
    ...
    \centering
    \includegraphics[draft=false]{pureshift/dpsyche_optsens3.png}
...
\begin{figure}[htb]
    \centering
    \includegraphics[draft=false]{pureshift/tsedpsyche_optsens3.png}
...
\begin{figure}[htb]
    \centering
    \includegraphics[draft=false]{pureshift/opt_npulses.png}
