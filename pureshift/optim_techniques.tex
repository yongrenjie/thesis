...
\begin{figure}[htb]
    ...
    \caption[Evaluation of $\fphase$ and $\fdiff$ cost functions on synthetic data]{
        ...
        \textbf{(\subref*{fig:fa_scan_synthetic_fphase})} The $\fphase$ cost function.
        \textbf{(\subref*{fig:fa_scan_synthetic_fdiff})} The $\fdiff$ cost function, measured against a spectrum with no phase distortion and an SNR of 500.
    }
