...
\begin{figure}[!ht]
    \centering
    \includegraphics[]{pureshift/example.png}%
    {\phantomsubcaption\label{fig:pureshift_example_coupled}}%
    {\phantomsubcaption\label{fig:pureshift_example_pureshift}}%
    \caption[Example of a pure shift spectrum]{
        \textbf{(\subref*{fig:pureshift_example_coupled})} A pulse--acquire \proton{} spectrum.
        \textbf{(\subref*{fig:pureshift_example_pureshift})} The corresponding PSYCHE pure shift spectrum.
